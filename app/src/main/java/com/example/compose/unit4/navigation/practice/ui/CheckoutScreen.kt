 ...
 */
package com.example.compose.unit4.navigation.practice.ui
...
import com.example.compose.unit4.navigation.practice.model.MenuItem
import com.example.compose.unit4.navigation.practice.model.OrderUiState
...
fun CheckoutScreenPreview() {
    CheckoutScreen(
        orderUiState = OrderUiState(
            entree = NavigationDataSource.entreeMenuItems[0],
            sideDish = NavigationDataSource.sideDishMenuItems[0],
            accompaniment = NavigationDataSource.accompanimentMenuItems[0],
